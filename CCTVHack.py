...
print('\n')
print ("""\033[0;32m
CCTV Project By: LEGION7_Hacker's Team                                                                                   
 ,-----. ,-----.,--------.,--.   ,--.,--.  ,--.              ,--.                  
'  .--./'  .--./'--.  .--' \  `.'  / |  '--'  | ,--,--. ,---.|  |,-. ,---. ,--.--. 
|  |    |  |       |  |     \     /  |  .--.  |' ,-.  || .--'|     /| .-. :|  .--' 
'  '--'\'  '--'\   |  |      \   /   |  |  |  |\ '-'  |\ `--.|  \  \\   --.|  |    
...
""")
print('\n')
print(green+'%37s' % '   |Devoloped By : Tn.Cr0DiXZeroTeeN7_|')
print(red+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print(blue+'Youtube Chanel: https://www.youtube.com/Cr0DiX666')
print(blue+'Telegarm Grop : https://t.me/+x2-NLvR6fBdmNDI1')
print(red+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
